...
class PredictionMetrics:
    ...
    def plot_confusion_matrix(labels,predictions,label_map,filename,title):
        """
        Plots a confusion matrix which illstrates the number of predictions were correct when 
        compared to the target.

        Args:
            labels: Target variables
            predictions: Predictions from the neural network 
            label_map: Annotation for the categorical variables
            title: Uses the appropriate title 
        ...
        plt.title(f'Confusion Matrix for {title} Predictions')
        plt.tight_layout()
    ...
    def plot_losses(train_losses, val_losses, filename):
        ...
        Args:
            train_losses: It is a dictionary of the various losses that occured during the training phase.
            val_losses: It is a dictionary of the various loss that occured during the validaiton phase.
            filenme: Path and the name of the file to save the plot.
