...
if __name__ == "__main__":
    ...
    #plot_losses(train_losses,filename='/home/chandru/binp37/results/plots/metasub/training_losses_nn_model_lat_long.png')
    #plot_confusion_matrix(all_labels_continents,all_predictions_continents,continent_encoding_map,filename='/home/chandru/binp37/results/plots/metasub/cofusion_matrix_nn_model_lat_long.png')
    #plot_points_on_world_map(true_lat,true_long,predicted_lat,predicted_long,filename='/home/chandru/binp37/results/plots/metasub/world_map_nn_model_lat_long.png')
