...
#df = pd.read_csv("/home/chandru/binp37/results/metasub_training_testing_data.csv")
#in_data, le_continent, le_city, stdscaler_lat, stdscaler_long, coordinate_scaler ,continent_encoding_map, city_encoding_map = process_data(df)
#
#print(in_data.head())